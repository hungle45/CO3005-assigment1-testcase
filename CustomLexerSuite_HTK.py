...
#----------------- [TEST KEYWORD] -----------------#
    ...
    def test_60(self):
        self.assertTrue(TestLexer.test(" integer void float",
        "integer,void,float,<EOF>",162))
...
#----------------- [TEST TOKEN] -----------------#
    ...
    def test_75(self): 
        ...
        main: function void () {
            ...
            printint(x);
        """,
        "main,:,function,void,(,),{,delta,:,integer,=,fact,(,3,),;,inc,(,x,,,delta,),;,printint,(,x,),;,<EOF>",175))

    def test_76(self): 
        self.assertTrue(TestLexer.test(""" 
        inc: function void (out n: integer, delta:integer) 
        """,
        "inc,:,function,void,(,out,n,:,integer,,,delta,:,integer,),<EOF>",176))

    def test_77(self): 
        self.assertTrue(TestLexer.test(""" out n : integer   """,
        "out,n,:,integer,<EOF>",177))
    ...
    def test_81(self): 
        self.assertTrue(TestLexer.test(""" x,y,z: integer= 1,2,3; """,
        "x,,,y,,,z,:,integer,=,1,,,2,,,3,;,<EOF>",181))

    def test_82(self): 
        self.assertTrue(TestLexer.test(""" x: integer = 65; """,
        "x,:,integer,=,65,;,<EOF>",182))
    ...
    def test_86(self): 
        ...
        """,
        "{,r,,,s,:,integer,;,r,=,2.0,;,a,,,b,:,array,[,5,],of,integer,;,s,=,r,*,r,*,myPI,;,a,[,0,],=,s,;,},<EOF>",186))
...
#----------------- [TEST ADDITIONAL] -----------------#
    ...
    def test_92(self): 
        ...
        x: integer = a[0,0];
        """,
        "a,[,2,,,3,],of,integer,;,x,:,integer,=,a,[,0,,,0,],;,<EOF>",192))
    ...
    def test_100(self): #note check again
        ...
        """,
        "x,:,integer,;,y,:,integer,=,5,;,if,(,x,==,5,),y,=,5,else,y,=,4,<EOF>",200))
